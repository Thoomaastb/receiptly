			...
			<div class="flex-none pt-3">
				...
				<div class="flex flex-wrap items-center gap-x-2 gap-y-0.5 px-3 pt-1.5 text-[10px] leading-tight text-hifi-text-faint">
					...
					<a
						...
						aria-label={m.attribution.websiteLink}
						title={m.attribution.websiteLink}
						class="inline-flex items-center transition-colors hover:text-hifi-text-muted"
					>
						<svg
							width="12"
							height="12"
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						aria-label={m.attribution.repoLink}
						title={m.attribution.repoLink}
						class="inline-flex items-center transition-colors hover:text-hifi-text-muted"
					>
						<svg
							width="12"
