			...
			<div class="flex-none pt-3">
				...
				<div class="flex flex-wrap items-center gap-x-2 gap-y-0.5 px-3 pt-1.5 text-[10px] leading-tight text-hifi-text-faint">
					...
					<a
						...
						class="inline-flex items-center gap-1 transition-colors hover:text-hifi-text-muted"
					>
						<svg
							width="12"
							height="12"
						...
						<span class="underline decoration-dotted underline-offset-2">{m.attribution.websiteLink}</span>
					</a>
					<a
					...
					>
						...
						<span class="underline decoration-dotted underline-offset-2">{m.attribution.repoLink}</span>
					</a>
				</div>
			</div>
		</aside>
