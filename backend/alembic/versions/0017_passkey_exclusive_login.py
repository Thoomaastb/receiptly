...
Warum diese Spalte nicht schon zusammen mit `household_security_settings` in Migration
0014 angelegt wurde: siehe Docstring dort sowie in
`app/models/household_security_settings.py`.
